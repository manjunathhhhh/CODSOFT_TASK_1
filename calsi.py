...
def clear():
    ...
    equation_text=""
window=Tk()
window.title("arithematic calculator")
...
label=Label(window,textvariable=equation_label,font=('consolas',50),bg="WHITE",width=24,height=2);
label.pack()
frame=Frame(window)
frame.pack()

buton1=Button(frame,text=1,height=4,width=9, font=35,command=lambda:button_press(1))
...
buton9=Button(frame,text=9,height=4,width=9, font=35,command=lambda:button_press(9))
